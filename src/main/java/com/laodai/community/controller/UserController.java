...
import com.laodai.community.annotation.LoginRequired;
import com.laodai.community.entity.User;
import com.laodai.community.service.FollowService;
...
import com.laodai.community.util.HostHolder;
...
public class UserController implements CommunityConstant {
    ...
    public String uploadHeader(MultipartFile headerImage, Model model){
        ...
        //更新当前你用户的头像的路径(web访问路径)
        // http://localhost:8080/cummunity/user/header/xxx.png
