...
import com.laodai.community.dao.LoginTicketMapper;
import com.laodai.community.dao.UserMapper;
import com.laodai.community.entity.LoginTicket;
...
import com.laodai.community.util.MailClient;
...
//        return userMapper.selectById(id);
    ...
    public Map<String,Object> register(User user){
        ...
        //验证账号
        User uAlready = userMapper.selectByName(user.getUsername());
        if (uAlready != null) {
            map.put("usernameMsg","该账号已存在!");
            return map;
        }
        //验证邮箱
        uAlready = userMapper.selectByEmail(user.getEmail());
        if (uAlready != null) {
